    ...
    <main>
      ...
      <section className={styles.sectionHero}>
        <h1 className={styles.title}>
          Adopciones responsables para proteger a <br /> los animales en
          Colombia
        </h1>
        ...
        <div className={styles.containerHero}>
          <div className={styles.spaceOne}>
            <img
              src={Hero}
              alt="Imagen alusiva a una adopcion de una mascota"
              className={styles.imageDog}
            />
          </div>
          <div className={styles.spaceTwo}>
            <h2 className={styles.titleSpaceTwo}>
              Estamos construyendo una plataforma para que los refugios se
      ...
      <section>
        <div className={styles.whatIs}>
          <h3 className={styles.textTitle}>¿Qué es</h3>
        ...
        <div className={styles.containerWhatsIS}>
          <div className={styles.spaceOneMap}>
            <h4 className={styles.titleWhatsIS}>
              <img
                className={`${styles.imageText} ${styles.marginLeftZero}`}
                src={Logo}
                alt="Logo del Registro Nacional Adopcion Animal"
              />
              es una plataforma en desarrollo que permitirá a los refugios de
              animales en Colombia registrar adoptantes y compartir información
              para evitar que personas con antecedentes de maltrato o abandono
              adopten nuevamente.
            </h4>
          </div>
          ...
          <div className={styles.spaceTwoMap}>
            <img
              ...
              src={Map}
              alt="imagen de mapa de Registro Nacional Adopcion Animal"
            />
          </div>
        </div>
      ...
      <section className={styles.containerSetionForm}>
        <h3 className={styles.titleForm}>
          ¿Quieres ayudar a proteger a los animales en Colombia?
        </h3>
        <h3 className={styles.subTitleForm}>
          Déjanos tus datos y te mantendremos informado sobre el lanzamiento de
        </h3>
